...
class UsersTableSeeder extends Seeder {
    public function run()
    {
		DB::table('users')->insert(['id' => 1, 'name' => 'Test User', 'email' => 'test@test.com', 'password' => '12345']);
    }
}
...
class MunicipiosTableSeeder extends Seeder {
    ...
    {
    	DB::unprepared("
    		INSERT INTO `municipios` (`co_municipio`, `nome`, `uf`) VALUES
			...
			(310000,'MINAS GERAIS','MG'),
			(240000,'RIO GRANDE DO NORTE','RN'),
			(530000,'DISTRITO FEDERAL','DF'),
			(120000,'ACRE','AC'),
			(160000,'AMAPA','AP'),
			(140000,'RORAIMA','RR'),
			(270000,'ALAGOAS','AL'),
			(130000,'AMAZONAS','AM'),
			(320000,'ESPIRITO SANTO','ES'),
			(520000,'GOIAS','GO'),
			(410000,'PARANA','PR'),
			(260000,'PERNAMBUCO','PE'),
			(220000,'PIAUI','PI'),
			(430000,'RIO GRANDE DO SUL','RS'),
			(420000,'SANTA CATARINA','SC'),
			(350000,'SAO PAULO','SP');
		");
    }
}
...
class PlanosTableSeeder extends Seeder {
    ...
    {
    	DB::unprepared("
    		INSERT INTO `planos` (`id`, `nome`, `created_at`, `updated_at`) VALUES
			(1, 'All Saúde', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(2, 'Amil', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(3, 'Assim', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(4, 'Bradesco', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(5, 'Cassi', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(6, 'Geap', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(7, 'Golden', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(8, 'GreenLine', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(9, 'Hapvida', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(10, 'Intermédica', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(11, 'Itálica', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(12, 'Marítima', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(13, 'Medicol', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(14, 'Memorial', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(15, 'NortreDame', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(16, 'Plena', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(17, 'Real', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(18, 'São Cristóvão', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(19, 'Santa Amália', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(20, 'Santa Casa', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(21, 'Santa Helena', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(22, 'SulAmérica', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(23, 'Unimed', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(24, 'Universal', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
			(25, 'Viva', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
		");
	}
}
...
class DenunciasTableSeeder extends Seeder {
    public function run()
    {
		DB::table('denuncias')->insert(['id' => 1, 'usuario' => 1, 'tipo' => 1, 'co_municipio' => 330455, 'provedor' => 'SUS', 'plano' => 3, 'data' => date('Y-m-d'), 'descricao' => 'Lorem ipsum dolor sit amen.']);
		DB::table('denuncias')->insert(['id' => 2, 'usuario' => 1, 'tipo' => 2, 'co_municipio' => 330455, 'provedor' => 'SUS', 'plano' => 3, 'data' => date('Y-m-d'), 'descricao' => 'Lorem ipsum dolor sit amen.']);
		DB::table('denuncias')->insert(['id' => 3, 'usuario' => 1, 'tipo' => 3, 'co_municipio' => 330455, 'provedor' => 'SUS', 'plano' => 3, 'data' => date('Y-m-d'), 'descricao' => 'Lorem ipsum dolor sit amen.']);
		DB::table('denuncias')->insert(['id' => 4, 'usuario' => 1, 'tipo' => 4, 'co_municipio' => 330455, 'provedor' => 'SUS', 'plano' => 3, 'data' => date('Y-m-d'), 'descricao' => 'Lorem ipsum dolor sit amen.']);
		DB::table('denuncias')->insert(['id' => 5, 'usuario' => 1, 'tipo' => 5, 'co_municipio' => 330455, 'provedor' => 'SUS', 'plano' => 3, 'data' => date('Y-m-d'), 'descricao' => 'Lorem ipsum dolor sit amen.']);
		DB::table('denuncias')->insert(['id' => 6, 'usuario' => 1, 'tipo' => 6, 'co_municipio' => 330455, 'provedor' => 'SUS', 'plano' => 3, 'data' => date('Y-m-d'), 'descricao' => 'Lorem ipsum dolor sit amen.']);
	}
}
